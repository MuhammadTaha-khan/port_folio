...
import { useParams } from "next/navigation"; // Use useParams to get URL parameters
...
const Desc: React.FC = () => {
  ...
  const defaultProjectDetailsValue: Project = {
    id: 0,
    title: "",
    description: "",
    imageUrl: null,
  ...
  const [projectDetails, setProjectDetails] = useState<Project>(defaultProjectDetailsValue);
  ...
  return (
    <div>
      ...
      <div className="flex flex-col text-start mt-8 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
